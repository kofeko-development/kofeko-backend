...
export const evaluationService = {
  ...
  async aiEvaluate(
    ...
    const evaluation = await evaluationRepository.create({
      ...
      summary: result.hiringIntelligence.candidateSnapshot,
      whyCard: result.hiringIntelligence.roleFitSummary,
      rankingSummary: result.hiringIntelligence.roleFitSummary,
      roleFitNotes: result.scores.scoreRationale,
      sectionScores: {
        capabilityFit: result.scores.capabilityFit,
        experienceScopeFit: result.scores.experienceScopeFit,
        explicitRequirementFit: result.scores.explicitRequirementFit,
      },
      skillMatches: result.scores.capabilityMatches as any,
      parsedResumeData: result.parsedResume as any,
      hiringIntelligence: result.hiringIntelligence as any,
      aiGenerated: true,
      evaluatedBy: actorId,
    });
